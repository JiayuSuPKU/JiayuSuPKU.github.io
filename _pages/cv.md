...
* June 2020 - present: Bioinformatics Engineer, GeneDock Inc., Beijing, China
  * Accomplishments:
    1. Developed R package [gdreports](https://gitlab.genedock.com/sujiayu/gdreports) to allow the automatic generation and customization of PDF and Web reports using R Markdown. 
    2. Designed and implemented an end-to-end quality control (QC) and reporting system for whole-genome sequencing (WGS) data.
    3. Optimized the cloud computing pipeline for clinical WGS data. Benchmarked and implemented tools for de novo mutation discovery and SV/CNV family joint-calling.
